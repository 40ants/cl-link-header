# -*- coding: utf-8 -*-
#
# link-header documentation build configuration file, created by
...
htmlhelp_basename = 'link-headerdoc'
...
latex_documents = [
  ('index', 'link-header.tex', u'link-header Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'link-header', u'link-header Documentation',
     [u''], 1)
]
